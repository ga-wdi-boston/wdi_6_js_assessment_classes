...
Cat.prototype = {
  description: function(){
    return this.name + ' is a ' + this.age + ' yr old ' + this.color + ' cat.';
  }
};
///// Question 3
...
var louie = new Cat('Louie', '5', 'orange');
...
var louieDescription = louie.description();

///// Question 5
// Set the age of the `Cat` instance you created in question 3 to one higher
// than its current age.

louie.age = louie.age + 1;

// To update the louieDescription variable:
louieDescription = louie.description();
